...
/**
 * Flutter's CircleAvatar for a network image — RenderImage already draws a
 ...
 * no new native capability — it's the same convenience NativeIconCircle
 ...
 */
final class NativeImageCircle implements RenderNode
{
    private readonly RenderImage $content;

    public function __construct(
        string $url,
        private readonly float $diameter = 40.0,
    ) {
        $this->content = new RenderImage($url, $diameter, $diameter, $diameter / 2);
    }
